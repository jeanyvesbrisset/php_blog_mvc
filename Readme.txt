...
-------------------------RESTE A FAIRE ---------------
OK Redireciton register
OK Supprimer / editer / ajouter user quand admin
OK Commentaires
// Pages blog Order articles
OK Gerer Les uplaods d'images
// Gerer Input file css
// Gérer les cats / Creation admin
// Suppresion de son propre compte
OK Deactivation de compte
// Verifier pour racine si user ban 
// Profil admin
// Catgegori single post + list posts ?
